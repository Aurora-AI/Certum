...
describe('GravityGallery Component', () => {
  ...
  it('deve renderizar múltiplos cards (Pillars + Products)', () => {
    ...
    // Verifica se há múltiplos cards renderizados
    const cards = container.querySelectorAll('[class*="flex-shrink-0"]');
  ...
  it('deve ter background escuro (#050505)', () => {
    ...
    const mainContainer = container.querySelector('[class*="bg-\\[\\#050505\\]"]');
    expect(mainContainer).toBeInTheDocument();
  });

  it('deve renderizar o indicador de scroll "Drag / Scroll"', () => {
    render(<GravityGallery />);

    const scrollIndicator = screen.getByText(/Drag \/ Scroll/i);
